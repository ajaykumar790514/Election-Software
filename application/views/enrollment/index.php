                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a href="<?=$new_url?>" class="btn btn-primary btn-sm" class="btn btn-primary btn-sm add-btn"> 
                                ...
                                <form autocomplete="off" class="form dynamic-tb-search" action="<?=$tb_url?>" method="POST" enctype="multipart/form-data" tagret-tb="#tb">
                                        ...
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="commissionaires" id="commissionaires" class="select2 form-select form-control input-sm" onchange="fetch_district(this.value)">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="district" id="district" class="select2 form-select form-control input-sm" onchange="fetch_tehsil(this.value)">
                                                <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="tehsil" id="tehsil" class="select2 form-select form-control input-sm" onchange="fetch_ward(this.value)" >
                                                <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="ward" id="ward" class="select2 form-select form-control input-sm" onchange="fetch_block(this.value)">
                                                <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="block" id="block" class="select2 form-select form-control input-sm" onchange="fetch_panchayat(this.value)">
                                                <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-lg-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select name="panchayat" id="panchayat" class="select2 form-select form-control input-sm">
                                                <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                            <div class="col-md-3 col-lg-4 col-sm-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="text" class="form-control input-sm" name="name" id="name" placeholder="Search  Pincode ..." />
                                                </div>
                                            </div>
