            ...
            <?php $i = 1; foreach($election_groups as $el): ?>
               <tr class="justify-content-center">
                   ...
                   <td>
                       ...
                       if (isset($winner)):
                       $this->operations_model->AssignMemberPosition($winner->member_id,$election_id,$group_id);
                        ?>
                           <table class="table table-bordered mb-0 justify-content-center">
                               ...
                               <tbody>
                                   <tr class="text-success">
                                       <td><?=$winner->enrollment_no;?></td>
                                       <td><?=$winner->fname . ' ' . $winner->mname . ' ' . $winner->lname;?></td>
                                       <td><?=$winner->father_name;?></td>
                                       <td><?=$winner->mobile;?></td>
                                       <td><?=$winner->email;?></td>
                                       <td><?=$winner->aadhaar_no;?></td>
                                   </tr>
                               </tbody>
                           </table>
                       <?php else: ?>
                           <p class="text-center text-danger">No winner found for this election blocks pincode.</p>
                       <?php endif; ?>
                   </td>
               </tr>
           <?php endforeach; ?>
           ...
           <?php $i = 1; foreach ($blocks as $block): ?>
               <tr class="justify-content-center">
                   ...
                   <td>
                       ...
                       <?php else: ?>
                           <p class="text-center text-danger">No winner found for this block pincode.</p>
                       <?php endif; ?>
                   </td>
               </tr>
           <?php endforeach; ?>
                ...
                <?php }else{;
                $i = 1; foreach ($enrollment as $enroll): ?>
               <tr class="justify-content-center">
                   <td class="sr_no"><?=$i++;?></td>
                   ...
                   <td>
                       ...
                       <?php else: ?>
                           <p class="text-center text-danger">No winner found for this family pincode.</p>
                       <?php endif; ?>
                   </td>
               </tr>
           <?php endforeach; 
