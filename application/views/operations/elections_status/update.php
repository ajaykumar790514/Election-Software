...
<input type="hidden" value="<?=@$country->code;?>" id="country" >
     ...
     <div class="col-lg-6 col-sm-12 col-md-6">
      <div class="form-group">
          ...
          <select name="commissionaires" id="commissionaires1" class="select2 form-select form-control" onchange="fetch_district1(this.value)">
          <option value="<?=$value->commissionaires_id;?>">Block <?=$value->commissionaires_name;?></option>
          </select>
      </div>
     </div>
     <div class="col-lg-6 col-sm-12 col-md-6">
      <div class="form-group">
          ...
          <select name="district" id="district1" class="select2 form-select form-control" onchange="fetch_tehsil1(this.value)">
          <option value="<?=$value->district_id;?>">Block <?=$value->district_name;?></option>
          </select>
      </div>
     </div>
     <div class="col-lg-6 col-sm-12 col-md-6">
      <div class="form-group">
          ...
          <select name="tehsil" id="tehsil1" class="select2 form-select form-control" onchange="fetch_ward1(this.value)" >
          <option value="<?=$value->tehsil_id;?>">Block <?=$value->tehsil_name;?></option>
          </select>
      </div>
     </div>
     <div class="col-lg-6 col-sm-12 col-md-6">
      <div class="form-group">
          ...
          <select name="ward" id="ward1" class="select2 form-select form-control" onchange="fetch_block1(this.value)">
          <option value="<?=$value->ward_block_id;?>">Block <?=$value->ward_block_name;?></option>
          </select>
      </div>
     </div>
     <div class="col-lg-6 col-sm-12 col-md-6">
      <div class="form-group">
          ...
          <select name="block" id="block1" class="select2 form-select form-control" onchange="fetch_panchayat1(this.value)">
          <option value="<?=$value->block_nyay_id;?>">Block <?=$value->block_nyay_name;?></option>
          </select>
      </div>
     </div>
     <div class="col-lg-6 col-sm-12 col-md-6">
      <div class="form-group">
          ...
          <select name="panchayat" id="panchayat1" class="select2 form-select form-control">
          <option value="<?=$value->panchayat_id;?>">Block <?=$value->panchayat_name;?></option>
          </select>
      </div>
     </div>
		<div class="col-lg-6 col-sm-12 col-md-6">
    <div class="form-group mb-0">
       ...
       <select name="group_id" class="form-control group_id1" id="group_id1" >
        <option value="<?=$value->group_id;?>">Block <?=$value->groups;?></option>
        </select>
    </div>
    </div>
    <div class="col-lg-6 col-sm-12 col-md-6">
    <div class="form-group mb-0">
       <label for="name" class="required">Level  :</label>
       <select name="level_id" class="form-control">
        <option value="">--Select--</option>
        <?php foreach($levels as $le):?>
        <option value="<?=$le->id;?>" <?php if($le->id==$value->level_id){ echo "selected";} ;?>  ><?=$le->level;?></option>
         <?php endforeach;?>   
       </select>
    </div>
    </div>
    ...
    <div class="form-group mb-0">
       ...
       <input type="date" name="election_date" class="form-control"   value="<?=$value->election_date;?>">
    </div>
    </div>
    <div class="col-lg-6 col-sm-12 col-md-6">
    <div class="form-group mb-0">
       <label for="name" class="required">Election Start Time :</label>
       <input type="time" name="election_start_time" class="form-control" value="<?= date('H:i', strtotime($value->election_start_time)) ?>">
    ...
    <div class="form-group mb-0">
       ...
       <input type="number" name="validity" value="<?=$value->validity;?>"  placeholder="Enter Validity" class="form-control" min="1" >
    </div>
    <input type="hidden" name="pincode" id="pincode1" value="<?=$value->pincode;?>">
    </div>
