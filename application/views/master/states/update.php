...
<div class="col-lg-12 col-sm-12 col-md-12">
          ...
          <option value="<?=$country->id;?>" <?php if($value->country_id==$country->id){ echo "selected";} ;?> ><?='( '.$country->code.' )';?>  <?=$country->name;?></option>
          <?php  endforeach;?>
        </select>
            </div>
        </div>
     <div class="col-lg-3 col-sm-3 col-md-3">
            <div class="form-group">
				...
				<input type="number" class="form-control" value="<?=$value->code;?>" name="code" placeholder="Enter  code">
            </div>
        </div>
