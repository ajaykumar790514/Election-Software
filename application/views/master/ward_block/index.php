                                        ...
                                        <div class="row justify-content-center">
                                           ...
                                           <div class="col-md-3">
                                                <div class="form-group mb-0">
                                                    <label for="name">Tehsil Zone </label>
                                                    <select class="form-select input-sm form-control " name="tehsil_id">
                                                <option value="">--Select--</option>
                                                <?php foreach($tehsils as $tehsil):?>
                                                <option value="<?=$tehsil->id;?>"><?='( '.$tehsil->code.' )';?> <?=$tehsil->name;?></option>
                                                <?php  endforeach;?>
                                                </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="text" class="form-control input-sm" name="name" id="name"  placeholder="Search Tehsil Zone Name / Code / Ward Block Name / Code ..." />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
