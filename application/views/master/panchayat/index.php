                                        ...
                                        <div class="row justify-content-center">
                                           ...
                                           <div class="col-md-3">
                                                <div class="form-group mb-0">
                                                    <label for="name">Block Nyay</label>
                                                    <select class="form-select input-sm form-control " name="block_nyay_id">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input type="text" class="form-control input-sm" name="name" id="name"  placeholder="Search  Block Nyay Name / Code / Panchayat Name / Code / Village  ..." />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
