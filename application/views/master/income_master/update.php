...
<div class="row">
     <div class="col-lg-3 col-sm-3 col-md-3">
            <div class="form-group">
				...
				<input type="number" class="form-control form-control" value="<?=$value->seq;?>" name="seq" placeholder="Enter  Seq">
            </div>
        </div>
		<div class="col-lg-9 col-sm-9 col-md-9">
            <div class="form-group">
                <label class="form-check-label  required">Income Title :</label>
				<input type="text" class="form-control form-control" value="<?=$value->title;?>" name="title" placeholder="Enter  Title">
            </div>
        </div>
</div>
</div>
